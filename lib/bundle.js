...
const TERSER_STRATEGIES = {
    safe: {
        ...
        compress: {
            ...
            unsafe: false,
            unsafe_proto: false,
            sequences: false, // Keep statements separate
    ...
    aggressive: {
        ...
        compress: {
            ...
            // --- SAFETY ADJUSTMENTS FOR MAGENTO ---
            pure_getters: false, // CHANGED: Too risky for legacy jQuery plugins
            unsafe: false,       // CHANGED: Disabled to prevent object transformation bugs
            unsafe_proto: false, // CHANGED: Prototype protection
            sequences: false,    // CHANGED: Preserves execution order of comma-separated definitions
            hoist_funs: false,   // CHANGED: Don't move function declarations (breaks shim dependencies)
